...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        :root { --primary-color: #0056b3; --primary-dark: #004494; --bg-light: #e7f1ff; }

        /* --- 1. SLIDER ẢNH --- */
        .detail-gallery { border: 1px solid #dee2e6; border-radius: 12px; padding: 15px; background: #fff; overflow: hidden; }
        ...
        .brand-badge { 
            ...
            border: 1px solid #b3d7ff; display: inline-block; margin-bottom: 15px; 
        }
        
        .price-wrapper { background: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 25px; border-left: 5px solid var(--primary-color); }
        ...
        .specs-table i { color: var(--primary-color); width: 25px; text-align: center; margin-right: 5px; }

        /* Nút Mua Hàng */
        .btn-buy-now { 
            background: linear-gradient(135deg, var(--primary-color) 0%, var(--primary-dark) 100%); 
            color: #fff; font-size: 1.3rem; font-weight: 800; text-transform: uppercase; 
            padding: 16px; border-radius: 8px; border: none; width: 100%; 
            box-shadow: 0 4px 15px rgba(0, 86, 179, 0.3); transition: all 0.3s ease; 
        }
        .btn-buy-now:hover { 
            background: linear-gradient(135deg, var(--primary-dark) 0%, #003366 100%); 
            transform: translateY(-3px); box-shadow: 0 6px 20px rgba(0, 86, 179, 0.4); color: #fff; 
        }
        ...
        .section-header { font-size: 1.4rem; font-weight: 800; border-left: 5px solid var(--primary-color); padding-left: 15px; margin-bottom: 25px; color: #333; }
        ...
        .product-card .img-wrap { height: 200px; width: 100%; display: flex; align-items: center; justify-content: center; overflow: hidden; background-color: #fff; padding: 15px; border-bottom: 1px solid #f8f9fa; }
        .product-card .img-wrap a { display: flex; width: 100%; height: 100%; align-items: center; justify-content: center; }
        .product-card .img-wrap img { max-height: 100%; max-width: 100%; width: auto; height: auto; object-fit: contain; margin: auto; }
        ...
        .btn-buy { width: 100%; border: 1px solid var(--primary-color); background: #fff; color: var(--primary-color); padding: 6px; border-radius: 4px; font-weight: 600; margin-top: 10px; transition: 0.2s; text-align: center; display: inline-block; }
    ...
    <div class="container py-4">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active fw-bold text-dark" aria-current="page"><asp:Label ID="lblTenMayBreadcrumb" runat="server"></asp:Label></li>
            </ol>
        </nav>
        ...
        <div class="row g-4">
                            ...
                            <asp:Repeater ID="rptAlbum" runat="server">
                                <ItemTemplate>
                                    <div class='carousel-item <%# Container.ItemIndex == 0 ? "active" : "" %>'>
                                        <img src='<%# ResolveUrl("~/Images/Products/" + Eval("DuongDan")) %>' 
                                             alt="Ảnh sản phẩm" 
                        ...
                        <asp:Repeater ID="rptThumb" runat="server">
                            <ItemTemplate>
                                <div class="thumb-item" onclick="var myCarousel = document.getElementById('productCarousel'); var carousel = new bootstrap.Carousel(myCarousel); carousel.to(<%# Container.ItemIndex %>);">
                                    <img src='<%# ResolveUrl("~/Images/Products/" + Eval("DuongDan")) %>' onerror="this.src='<%= ResolveUrl("~/Images/no-image.png") %>'; this.onerror=null;">
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="ps-lg-3">
                    ...
                    <h1 class="product-title-detail"><asp:Label ID="lblTenMay" runat="server"></asp:Label></h1>
                    <div class="mb-3 d-flex align-items-center gap-2">
                        <span class="text-muted small">Mã SP: <asp:Label ID="lblMaMay" runat="server" Font-Bold="true"></asp:Label></span>
                            ...
                            <div class="product-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <asp:LinkButton ID="btnMuaLienQuan" runat="server" CssClass="btn btn-buy" 
                                        CommandArgument='<%# Eval("MaMay") %>' OnClick="btnMuaLienQuan_Click"
